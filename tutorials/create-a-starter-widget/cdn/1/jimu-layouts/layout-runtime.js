      ...
      `,null!=e.offsetX||null!=e.offsetY?`translate(${(null!==(i=e.offsetX)&&void 0!==i?i:0)*d}px, ${null!==(a=e.offsetY)&&void 0!==a?a:0}px)`:null]}render(){const{span:e,offset:t,layoutId:o,layoutItem:i}=this.props;if(null==i||i.isPending)return null;const a=n.lodash.assign({},Bt,i.setting),r=(0,n.classNames)("row-layout-item",`col-${e}`,`offset-${t}`),s=G(a.aspectRatio),l=se(this.props),[u,d]=this.getStyle(a);return(0,n.jsx)(Rt,Object.assign({css:u,style:{transform:d},className:r,layoutId:o,layoutItemId:i.id,forceAspectRatio:"ratio"===a.heightMode,aspectRatio:s,onClick:this.props.onClick},l))}}class Vt extends n.React.PureComponent{constructor(e){super(e),this.flipLeftRight=W()}collectBounds(){var e;const{transformedLayout:t}=this.props,n=null!==(e=t.order)&&void 0!==e?e:[];return this.childRects=[],n.forEach((e=>{var n,o;if(t.content[e].isPending)return;const i=null===(o=null===(n=t.content)||void 0===n?void 0:n[e])||void 0===o?void 0:o.bbox;null!=i&&this.childRects.push({layoutId:t.id,id:e,left:parseInt(i.left,10),width:parseInt(i.width,10),height:parseInt(i.height,10)})})),this.childRects.sort(((e,t)=>e.left-t.left))}getConfig(){var e;const{layout:t}=this.props;return null!==(e=t.setting)&&void 0!==e?e:Nt}createItem(e,t,o){var i;const{transformedLayout:a,isMultiRow:r}=this.props,s=this.getConfig(),l=e[t],u=null!==(i=s.space)&&void 0!==i?i:0;let d;if(0===t)d=l.left;else{const n=e[t-1];d=l.left-n.left-n.width}return(0,n.jsx)(Ft,{key:`${l.layoutId}_${l.id}`,offset:d,gutter:u,span:l.width,isMultiRow:r,layoutId:a.id,layoutItemId:l.id,layoutItem:a.content[l.id],alignItems:o.alignItems})}render(){var e,t;const{layout:o,className:i}=this.props;this.collectBounds();const r=this.childRects,s=this.getConfig(),l=null!==(e=s.style)&&void 0!==e?e:{},u=null!==(t=s.space)&&void 0!==t?t:0;return(0,n.jsx)(a.Consumer,null,(e=>(0,n.jsx)("div",{className:(0,n.classNames)("row-layout",i,{"row-rtl":this.flipLeftRight}),css:zt,"data-layoutid":o.id},(0,n.jsx)("div",{css:n.css`
                ...
                `},(0,n.jsx)("div",{css:n.css`
                  ...
                  `},r.length>0&&(0,n.jsx)(n.IntersectionContext.Provider,{value:{monitor:!1}},(0,n.jsx)(n.OneByOneAnimation,{oid:o.id,className:(0,n.classNames)("row h-100 m-0",{"flex-nowrap":!this.props.isMultiRow}),css:n.css`
                        ...
                        `},r.map(((e,t)=>this.createItem(r,t,l))))))))))}}class Ht extends n.React.PureComponent{constructor(e){super(e),this.onResize=(e,t)=>{var n;if(this.props.browserSizeMode!==this.props.mainSizeMode)return;if(0===e&&0===t)return;const{widgetId:o}=this.props;null!=(null===(n=window.runtimeInfo.widgets)||void 0===n?void 0:n[o])?window.runtimeInfo.widgets[o].height=t:window.runtimeInfo.widgets[o]={height:t}},this.handleDebounceResize=n.lodash.debounce(this.onResize,200)}findExtension(){const e=n.ExtensionManager.getInstance().getExtensions(`${n.extensionSpec.ExtensionPoints.LayoutTransformer}`);if((null==e?void 0:e.length)>0){const t=e.find((e=>e.layoutType===n.LayoutType.RowLayout));this.layoutTransform=null==t?void 0:t.transformLayout}}transform(){const{layout:e,layouts:t,browserSizeMode:n,mainSizeMode:o}=this.props;null==this.layoutTransform&&this.findExtension();let i=e;t[n]!==e.id&&null!=this.layoutTransform&&(i=this.layoutTransform(e,o,n)),this.finalLayout=i}createRow(){const{layout:e,layouts:t}=this.props;return(0,n.jsx)(Vt,{layouts:t,layout:e,transformedLayout:this.finalLayout,isMultiRow:this.finalLayout!==e})}render(){var e;const{layout:t,className:o}=this.props,i=null!==(e=t.setting)&&void 0!==e?e:Nt;return this.transform(),(0,n.jsx)("div",{className:(0,n.classNames)("layout d-flex",o),css:n.css`
          width: 100%;
          padding: ${y.styleUtils.toCSSPadding(i.style.padding)};
        `,"data-layoutid":t.id},this.createRow(),(0,n.jsx)(n.ReactResizeDetector,{handleHeight:!0,onResize:this.handleDebounceResize}))}}const Dt=n.ReactRedux.connect(A)(Ht);var Wt=r(7077),Gt=r.n(Wt);const Ut=e=>{const{className:t}=e,o=function(e,t){var n={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(n[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(o=Object.getOwnPropertySymbols(e);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(e,o[i])&&(n[o[i]]=e[o[i]])}return n}(e,["className"]),i=(0,n.classNames)("jimu-icon jimu-icon-component",t);return n.React.createElement(y.SVG,Object.assign({className:i,src:Gt()},o))};var _t=r(5339),Xt=r.n(_t);const Yt=e=>{const{className:t}=e,o=function(e,t){var n={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(n[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(o=Object.getOwnPropertySymbols(e);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(e,o[i])&&(n[o[i]]=e[o[i]])}return n}(e,["className"]),i=(0,n.classNames)("jimu-icon jimu-icon-component",t);return n.React.createElement(y.SVG,Object.assign({className:i,src:Xt()},o))},Zt=n.css`
  .max-grid-item-btn {
    display: none;
